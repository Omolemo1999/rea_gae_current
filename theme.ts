...
const themeOptions: ThemeOptions = {
  ...
  components: {
    ...
    MuiButton: { defaultProps: { disableElevation: true }, styleOverrides: { root: { borderRadius: 0, minHeight: 44, paddingInline: 18, transition: "transform .2s ease, box-shadow .2s ease, background .2s ease", "&:hover": { transform: "translateY(-1px)" }, "&.Mui-disabled": { opacity: .62 } } } },
    ...
    MuiChip: { styleOverrides: { root: { fontWeight: 750, borderRadius: 0 } } },
