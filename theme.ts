...
const themeOptions: ThemeOptions = {
  ...
  typography: {
    fontFamily: '"Inter", "Plus Jakarta Sans", "Segoe UI", Arial, sans-serif',
  ...
  components: {
    ...
    MuiButton: { defaultProps: { disableElevation: true }, styleOverrides: { root: { borderRadius: 9, minHeight: 44, paddingInline: 18, transition: "transform .2s ease, box-shadow .2s ease, background .2s ease", "&:hover": { transform: "translateY(-1px)" }, "&.Mui-disabled": { opacity: .62 } } } },
    ...
    MuiOutlinedInput: { styleOverrides: { root: { borderRadius: 9, backgroundColor: "#FFFFFF", "&:hover .MuiOutlinedInput-notchedOutline": { borderColor: "#9AA8BF" }, "&.Mui-focused .MuiOutlinedInput-notchedOutline": { borderWidth: 2 } } } },
    MuiChip: { styleOverrides: { root: { fontWeight: 750, borderRadius: 7 } } },
    MuiAlert: { styleOverrides: { root: { borderRadius: 9 } } },
    MuiDialog: { styleOverrides: { paper: { borderRadius: 14, boxShadow: "0 30px 90px rgba(0,0,0,.28)" } } },
